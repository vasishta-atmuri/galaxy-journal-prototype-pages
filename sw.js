const CACHE='journal-shell-cbd0bcc02039';
const ASSETS=["./","./index.html","./icon.svg","./icon-192.png","./icon-512.png","./manifest.webmanifest","./assets/index-CYgzYGyo.js","./assets/index-B_WOP1qc.css"];
